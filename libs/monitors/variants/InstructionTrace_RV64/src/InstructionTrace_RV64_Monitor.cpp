...
extern "C"
{
  ...
  int *InstructionTrace_RV64_Monitor_pc_new_buffer;
  ...
  int *InstructionTrace_RV64_Monitor_csr_reg_buffer;
...
void InstructionTrace_RV64_Monitor::connectChannel(Channel* channel_)
{
  ...
  InstructionTrace_RV64_Monitor_pc_new_buffer = static_cast<int*>(channel_->getTraceValueHook("pc_new"));
  ...
  InstructionTrace_RV64_Monitor_csr_reg_buffer = static_cast<int*>(channel_->getTraceValueHook("csr_reg"));
...
std::string InstructionTrace_RV64_Monitor::getBlockDeclarations(void) const
{
  ...
  ret_strs << "extern int *InstructionTrace_RV64_Monitor_pc_new_buffer;\n";
  ...
  ret_strs << "extern int *InstructionTrace_RV64_Monitor_csr_reg_buffer;\n";

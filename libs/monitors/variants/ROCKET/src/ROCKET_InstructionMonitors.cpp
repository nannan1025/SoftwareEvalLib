...
static InstructionMonitor *instrMonitor_div = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    ret_strs << "ROCKET_Monitor_rs1_data_buffer[*ROCKET_Monitor_instrCnt] = " << "*((RV64IMACFD*)cpu)->X["<< rs1 << "]" << ";\n";
    
    ret_strs << "ROCKET_Monitor_rs2_data_buffer[*ROCKET_Monitor_instrCnt] = " << "*((RV64IMACFD*)cpu)->X["<< rs2 << "]" << ";\n";
...
static InstructionMonitor *instrMonitor__def = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    ret_strs << "ROCKET_Monitor_typeId_buffer[*ROCKET_Monitor_instrCnt] = " << 66 << ";\n";
